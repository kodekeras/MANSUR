        ...
        <div class="container">
            <div id="colres">
                <div class="disp">';
                    ...
                    if(!empty($institusi)){
                        ...
                        echo '<h6 class="up">YPDM Bakti Nusantara 666</h6>';
                    }
                    if(!empty($nama)){
                        echo '<h5 class="up" id="nama">'.$nama.'</h5><br/>';
                    } else {
                        echo '<h5 class="up" id="nama">SMK Bakti Nusantara 666 Cileunyi</h5><br/>';
                    }
                    if(!empty($status)){
                        echo '<h6 class="status">'.$status.'</h6>';
                    } else {
                        echo '<h6 class="status">Akta Notaris:  No. /2018</h6>';
                    }
                    if(!empty($alamat)){
                        echo '<span id="alamat">'.$alamat.'</span>';
                    } else {
                        echo '<span id="alamat">Jalan Percobaan No. 65 Cileunyi Telp/Fax. (089) 329806 Bandung 64471</span>';
                    }
                    echo '
                </div>
                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>
                                <td id="right"><strong>Ringkasan</strong></td>
                            ...
                            <tr class="isi">
                                <td colspan="2">
                                    <strong>Disposisi :</strong><br/>'.$row['isi_disposisi'].'
            ...
            <div id="lead">
                ...
                if(!empty($kepsek)){
                    ...
                    echo '<p class="lead">Deni Danis Suara, S.T, M.Kom.</p>';
                }
                if(!empty($nip)){
                    echo '<p>NIP. '.$nip.'</p>';
                } else {
