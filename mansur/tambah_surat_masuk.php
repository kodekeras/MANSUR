    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper white darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=tsm&act=add" class="judul black-text">Tambah Data Surat Masuk</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col 12" method="POST" action="?page=tsm&act=add" enctype="multipart/form-data">

                    <!-- Row in form START -->
                    <div class="row">
                        <div class="input-field col s2 tooltipped" data-position="top" data-tooltip="Isi dengan angka">
                        ...
                        <br><br><br><br>
                        <div class="input-field col s2 tooltipped" data-position="top" data-tooltip="Diambil dari data referensi kode klasifikasi">
                        ...
                        <br><br><br><br>
                        <div class="input-field col s2 tooltipped" data-position="top" data-tooltip="Isi dengan huruf atau angka">
                        ...
                        <div class="input-field col s8">
                            <textarea id="isi" class="validate" name="isi" required></textarea>
                                <?php
                    ...
                    <div class="row">
                        <div class="col 6">
                            <button type="submit" name="submit" class="btn-large grey-light waves-effect waves-light">SIMPAN <i class="material-icons">done</i></button>
                        </div>
                        <div class="col 6">
                            <a href="?page=tsm" class="btn-large red waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                        </div>
                    </div>
