                    ...
                    <div class="col s12">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper white darken-1">
                                <ul class="left">
                                    <li class="waves-effect waves-light"><a href="#" class="judul black-text">Edit Disposisi Surat</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                    ...
                    <form class="col s12" method="post" action="">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s3">
                                ...
                                <input type="date" name="batas_waktu" value="<?php echo $row['batas_waktu']; ?>"required>
                                    <?php
                        ...
                        <div class="row">
                            ...
                            <div class="col 6">
                                <a href="?page=tsm&act=disp&id_surat=<?php echo $row['id_surat']; ?>" class="btn-large red waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                            </div>
                        </div>
