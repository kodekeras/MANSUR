                ...
                if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
                        ...
                        <div class="col s12">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper white darken-1">
                                    <ul class="left">
                                        <li class="waves-effect waves-light"><a href="#" class="judul black-text">Edit Klasifikasi Surat</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
                    ...
                    <div class="row jarak-form">
                        ...
                        <form class="col s12" method="post" action="?page=ref&act=edit">
                            ...
                            <!-- Row in form START -->
                            <div class="row">
                                <div class="input-field col s2 tooltipped" data-position="top" data-tooltip="Isi dengan huruf, angka, spasi dan titik(.)">
