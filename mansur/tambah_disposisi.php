                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper white darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul black-text"><i class="material-icons">description</i> Tambah Disposisi Surat</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="post" action="">
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <button type="reset" onclick="window.history.back();" class="btn-large red waves-effect waves-light">BATAL <i class="material-icons">clear</i></button>
                        </div>
                    </div>
