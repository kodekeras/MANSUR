    		  ...
    		  echo '
				...
				<div class="row jarak-card">
                    ...
                    <div class="">
				        ...
				        <table>
                            <center><h4 class="red-text">Yakin akan menghapus data ini?</h4></center>
				            <tbody>
				                <tr>
                        ...
                        <div class="card-action">
        	                <a href="?page=tsm&act=del&submit=yes&id_surat='.$row['id_surat'].'" class="btn-large red waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
        	                <a href="?page=tsm" class="btn-large grey-light waves-effect waves-light white-text">BATAL <i class="material-icons">clear</i></a>
    	                </div>
                        </center>
    	            </div>
                </div>
