                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper white darken-1">
                                        <div class="col m12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=gsm" class="judul black-text"><i class="material-icons">image</i> Galeri File Surat Masuk</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                            ...
                            <div class="row jarak-form black-text">
                                <form class="col s12" method="post" action="">
                                    <div class="input-field col s3">
                                        <label for="dari_tanggal">Dari Tanggal</label><br><br>
                                        <input type="date" name="dari_tanggal" required>
                                    </div>
                                    <div class="input-field col s3">
                                        <label for="sampai_tanggal">Sampai Tanggal</label><br><br>
                                        <input type="date" name="sampai_tanggal" required>
                                    </div>
                                    <br><br><br><br><br><br>
                                    <div class="col s6" style="margin-left: 300px;">
                                        <button type="submit" name="submit" class="btn-large waves-effect waves-light"> FILTER</button>&nbsp;&nbsp;

                                        <button type="reset" onclick="window.history.back()" class="btn-large red waves-effect waves-light">RESET <i class="material-icons">refresh</i></button>
                                    </div>
                                </form>
                            </div>
                            <!-- Row form END -->
                                    ...
                                    if(in_array($eks, $ekstensi) == true){
                                        echo '
                                            <div class="col m3">
                                                ...
                                                <a class="btn darken-1" href="?page=gsm&act=fsm&id_surat='.$row['id_surat'].'">Lihat Detail</a></center>
                                            </div>';
                                    } else {
...
/*kdjwakda*/
                        ...
                        if(mysqli_num_rows($query) > 0){
                            ...
                            <!-- Row form Start -->
                            <div class="row jarak-form black-text">
                                <form class="col s12" action="cetakperiode.php">
                                    <div class="input-field col s3">
                                        <label for="dari_tanggal">Dari Tanggal</label><br><br>
                                    ...
                                    <br><br><br><br><br><br>
                                    <div class="col s6" style="margin-left:470px;">
                                        <button type="submit" name="submit" class="btn-large waves-effect waves-light">FILTER</button>
                                    </div>
                                </form>
                            </div>
