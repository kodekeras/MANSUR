                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper white darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul black-text">Edit Data Surat Masuk</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                ...
                <form class="col s12" method="POST" action="?page=tsm&act=edit" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            <textarea class="validate" name="isi" required><?php echo $isi ;?></textarea>
                                <?php
