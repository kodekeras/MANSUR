        ...
        if(mysqli_num_rows($query) > 0){
            while($row = mysqli_fetch_array($query)){
                echo '
                    ...
                    <button onclick="window.history.back()" class="btn-large orange lighten-1 waves-effect waves-light left"><i class="material-icons">arrow_back</i> KEMBALI</button><br><br><br>
                        <ul class="collapsible white" data-collapsible="accordion">
                            <li>
                                <div class="collapsible-header white"><span class="add">Detail data surat masuk</span></div>
