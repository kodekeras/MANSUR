    ...
    if(empty($_SESSION['admin'])){
        ...
        echo '<!-- Row Start -->
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper white darken-1">
                                    <div class="col m12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=sett&sub=back" class="judul black-text"><i class="material-icons">storage</i> Backup Database</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
                ...
                if(isset($_REQUEST['backup'])){
                    ...
                    backup("localhost","root","","surat",$file,"*");
                            ...
                            <div class="col m12">
                                <div class="card">
                                    ...
                                    <div class="card-action">
                                        <form method="post" action="include/dbb.php">
