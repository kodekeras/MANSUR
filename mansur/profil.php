                    ...
                    <div class="col s12">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper white darken-1">
                                <ul class="left">
                                    <li class="waves-effect waves-light"><a href="?page=pro&sub=pass" class="judul black-text"><i class="material-icons">mode_edit</i> Edit Profil</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                ...
                <div class="row jarak-form">
                    ...
                    <form class="col s12" method="post" action="?page=pro&sub=pass">
                        ...
                        <div class="row">
                            ...
                            <br><br><br><br>
                            <div class="input-field col s3 tooltipped" data-position="top" data-tooltip="Isikan password lama Anda">
                        ...
                        <div class="row">
                            ...
                            <div class="col 6">
                                <a href="?page=pro" class="btn-large red waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                            </div>
                        </div>
...
?>
            ...
            <div class="row">
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper white darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul black-text"><i class="material-icons">person</i> Profil User</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="post" action="save.php">
                    ...
                    <div class="row">
                        <div class="col m12">
                            <a href="?page=pro&sub=pass" class="btn-large waves-effect waves-light">EDIT PROFIL<i class="material-icons">mode_edit</i></a>
                        </div>
                    </div>
