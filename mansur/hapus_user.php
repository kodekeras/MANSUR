    				    ...
    				    <div class="col m12">
                            <div>
                                <div class="card-content">
            				        <table>
                                        <center><h3 class="red-text">Anda yakin?</h3></center>
            				            <tbody>
            				                <tr>
                                ...
                                <div class="card-action">
            		                <a href="?page=sett&sub=usr&act=del&submit=yes&id_user='.$row['id_user'].'" class="btn-large red waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
            		                <a href="?page=sett&sub=usr" class="btn-large waves-effect waves-light white-text">BATAL <i class="material-icons">clear</i></a>
            		            </div>
                            </div>
                        </div>
                    </div>
