                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper white darken-1">
                                        <div class="col m12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=gsk" class="judul black-text"><i class="material-icons">image</i> Galeri File Surat Keluar</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                            ...
                            <div class="row jarak-form black-text">
                                <form class="col s12" method="post" action="">
                                    ...
                                    <div class="col s6">
                                        ...
                                        <button type="reset" onclick="window.history.back()" class="btn-large red waves-effect waves-light">RESET</button>
                                    </div>
                                </form>
                            </div>
                            <!-- Row form END -->
                                    ...
                                    if(in_array($eks, $ekstensi) == true){
                                        echo '
                                            <div class="col m3">
                                                ...
                                                <a class="btn darken-1" href="?page=gsk&act=fsk&id_surat='.$row['id_surat'].'">Lihat Detail</a>
                                                </center>
                                            </div>';
                                    } else {
                            ...
                            <div class="row jarak-form black-text">
                                <form class="col s12" method="post" action="">
                                    ...
                                    <div class="col s6" style="margin-left:470px;">
                                        <button type="submit" name="submit" class="btn-large blue waves-effect waves-light">FILTER</button>
                                    </div>
                                </form>
                            </div>
                            <!-- Row form END -->';
                                ...
                                if(empty($row['file'])){
                                    ...
                                    echo '
                                        <div class="col m3">
                                            <center>
                                            <img class="galeri materialboxed" data-caption="'.date('d M Y', strtotime($row['tgl_catat'])).'" src="./upload/surat_keluar/'.$row['file'].'"/>
                                            <a class="btn darken-1" href="?page=gsk&act=fsk&id_surat='.$row['id_surat'].'">Lihat Detail</a></center>
                                        </div>';
                                    } else {
