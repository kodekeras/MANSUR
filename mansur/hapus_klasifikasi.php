			    ...
			    <div class="col m12">
                    <div class="">
                        ...
                        <div class="card-action">
        	                <a href="?page=ref&act=del&submit=yes&id_klasifikasi='.$row['id_klasifikasi'].'" class="btn-large red waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
        	                <a href="?page=ref" class="btn-large waves-effect waves-light white-text">BATAL <i class="material-icons">clear</i></a>
        	            </div>
                        </center>
                    </div>
                </div>
