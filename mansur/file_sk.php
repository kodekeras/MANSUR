            ...
            while($row = mysqli_fetch_array($query)){
                echo '
                    <div class="row jarak-form">
                        <button onclick="window.history.back()" class="btn-large yellow darken-3 waves-effect waves-light left"><i class="material-icons">arrow_back</i> KEMBALI</button><br><br><br>
                        <ul class="collapsible white" data-collapsible="accordion">
                            <li>
                                <div class="collapsible-header white"><span class="add">Detail data surat keluar</span></div>
                                    <div class="">
