                            ...
                            <div class="col s12">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper white darken-1">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=sett" class="judul black-text"><i class="material-icons">work</i> Manajemen Instansi</a></li>
                                        </ul>
                                    </div>
                                </nav>
                            </div>
                        ...
                        <div class="row jarak-form">
                            ...
                            <form class="col s12" method="post" action="?page=sett" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col 6">
                                        <a href="./admin.php" class="btn-large red waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                                    </div>
                                </div>
