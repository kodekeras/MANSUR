            ...
            $pg = @$_GET['pg'];
                ...
                <div class="row">
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper white darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsk" class="judul black-text">Surat Keluar</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
                    ...
                    <div class="col s12" style="margin-top: 20px;">
                                <ul class="right">
                                     <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsk&act=add" class="green-text"><i class="material-icons md-24">add_circle</i> Tambah Data</a></li>
                                </ul>
                    </div>
                    <!-- Secondary Nav END -->
                </div>
                                ...
                                $i++;
                                  echo '
                                    ...
                                    if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 1){
                                      ...
                                      echo '<a class="btn small yellow waves-effect waves-light" href="?page=tsk&act=edit&id_surat='.$row['id_surat'].'">
                                                <i class="material-icons">edit</i></a>
                                            <a class="btn small red waves-effect waves-light" href="?page=tsk&act=del&id_surat='.$row['id_surat'].'">
