...
<head>
    ...
    <style type="text/css">
        ...
        .bg::before {
            content: '';
            background-image: url('./asset/img/login-m.png');
            ...
            <div class="col s12 m6 offset-m3 offset-m3">
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <?php
                        if(isset($_REQUEST['submit'])){
                            ...
                            if($_REQUEST['username'] == "" || $_REQUEST['password'] == ""){
                                ...
                                <a class="btn-large waves-effect waves-light green darken-1 col s11" href="./" style="margin: 20px 0 0 5px;"><i class="material-icons md-24">arrow_back</i> Kembali ke login form</a></div>';
                            } else {
                                ...
                                if(mysqli_num_rows($query) > 0){
                                    ...
                                    //session error
                                    $_SESSION['errLog'] = '<center>Username & Password salah!</center>';
                                    header("Location: ./");
                                    die();
                                }
                            }
                    ...
                    <form class="col s12 m12 offset-4 offset-4" method="POST" action="" >
                        ...
                        <div class="input-field col s12">
                            <button type="submit" class="btn-large waves-effect waves-light green-grey col s12" name="submit">Masuk</button>
                        </div>
                    </form>
                    <!-- Form END -->
                    <?php
