                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper white darken-1">
                            <ul class="">
                                <li class="waves-effect waves-light"><a href="?page=tsk&act=add" class="judul black-text">Tambah Data Surat Keluar</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="POST" action="?page=tsk&act=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <a href="?page=tsk" class="btn-large red waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                        </div>
                    </div>
