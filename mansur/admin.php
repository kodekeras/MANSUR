...
<main>
    ...
    ?>
        ...
        <div class="row">
            ...
            <div class="col s6" style="margin-top: 10px;">
                <div class="card black-text">
                    <div class="card-content">
                        <h4>Selamat Datang <?php echo $_SESSION['nama']; ?></h4><br>
            ...
            <div class="col s12 m4" style="border-radius:100%;">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title cyan-text">Jumlah Surat Masuk</span>
                        <?php echo '<h5 class="cyan-text link">'.$count1.' Surat Masuk</h5>'; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m4">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title red-text">Jumlah Surat Keluar</span>
                        <?php echo '<h5 class="red-text link">'.$count2.' Surat Keluar</h5>'; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m4">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title orange-text">Jumlah Disposisi</span>
                        <?php echo '<h5 class="orange-text link">'.$count3.' Disposisi</h5>'; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m4">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title purple-text">Jumlah Klasifikasi Surat</span>
                        <?php echo '<h5 class="purple-text link">'.$count4.' Klasifikasi Surat</h5>'; ?>
                    </div>
                </div>
            </div>
        ...
        <?php
            ...
            <div class="col s12 m4">
                <div class="card accent-2">
                    <div class="card-content">
                        <span class="card-title brown-text">Jumlah Pengguna</span>
                        <?php echo '<h5 class="brown-text link">'.$count5.' Pengguna</h5>'; ?>
                    </div>
                </div>
            </div>
            <!-- Info Statistic START -->
